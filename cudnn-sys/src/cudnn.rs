...
extern "C" {
    ...
    #[doc = " ::cuMemAlloc"]
    pub fn cudaMalloc(devPtr: *mut *mut ::libc::c_void, size: size_t) -> cudaError_t;
}
extern "C" {
    ...
    #[doc = " ::cudaFreeHost, ::cudaHostAlloc,"]
    #[doc = " ::cuMemAllocHost"]
    pub fn cudaMallocHost(ptr: *mut *mut ::libc::c_void, size: size_t) -> cudaError_t;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = " ::cuModuleGetGlobal"]
    pub fn cudaGetSymbolSize(size: *mut size_t, symbol: *const ::libc::c_void) -> cudaError_t;
}
extern "C" {
...
extern "C" {
    pub fn cudnnGetAlgorithmSpaceSize(
        handle: cudnnHandle_t,
        algoDesc: cudnnAlgorithmDescriptor_t,
        algoSpaceSizeInBytes: *mut size_t,
    ) -> cudnnStatus_t;
}
extern "C" {
